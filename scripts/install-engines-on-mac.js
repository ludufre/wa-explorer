...
// See `qePath` in `packages/server/constants.ts`, which gets set with the current platform
...
//   child_process.execSync('rm -rf node_modules/@prisma/engines && pnpm add @prisma/engines', {
//     stdio: [0, 1, 2],
//     env: {
//       ...process.env,
//       PRISMA_CLI_BINARY_TARGETS: "debian-openssl-1.1.x,darwin,darwin-arm64",
//     },
//   });
// }
